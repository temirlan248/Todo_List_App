...
import kz.temir.todolistapp.todoList.presentation.rv.TodoAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.todoRv.addItemDecoration(
            DividerItemDecoration(
                ...
                val divider =
                    ResourcesCompat.getDrawable(resources, R.drawable.divider_todo, null)
